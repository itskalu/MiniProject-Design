...
public class TryMe
{
   public void Try(){
       ...
       //assigning peaople to an arraylist
       ...
       System.out.println("num of people: "+BorrowerContainer.getInstance().getSize());
       System.out.println("num of copies: "+BorrowerContainer.getInstance().getSize());
